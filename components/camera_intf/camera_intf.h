...
#define USE_CAMERA              GC0328C_DEV//HM_1055_DEV//GC0328C_DEV// PAS6329_DEV  OV_7670_DEV  PAS6375_DEV  GC0328C_DEV
...
const uint8_t gc0328c_VGA_480_272_talbe[][2] = {
...
const uint16_t hm_1055_init_talbe[][2] = {
	{0x0022, 0x00},//	; RESET
	{0x0023, 0x00},//	;disable DATD[0-9]
	{0x0026, 0x79},//	; For 15fps @ 12MHz (MCLK=13.7M??) 0X39=29.7M//0x39
	{0x002A, 0x44},//	; Modified by Wilson
	{0x002B, 0x01},//	;
	{0x002C, 0x00},//	; Turn off DCC
	{0x0025, 0x80},//	; PLL on	//chen 0x00//0x01
	{0x0020, 0x00},//	;
	{0x0027, 0x30},//	; FPGA 24
	{0x0028, 0xC0},//	;
	{0x0004, 0x10},//	;
	...
	{0x05E8, 0x08},// ; 1280*720
	{0x05E9, 0x00},// ; 1280*720
	{0x05EA, 0xD7},// ; 1280*720
	{0x05EB, 0x02},// ; 1280*720
#else
