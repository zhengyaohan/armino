...
ble_err_t bk_ble_set_extended_adv_params(
                uint8_t   adv_handle,
...
ble_err_t bk_ble_set_extended_adv_data(
                ...
                uint8_t   adv_len,
                ble_cmd_cb_t callback);
ble_err_t bk_ble_set_extended_adv_enable(
                uint8_t    enable,
                ...
                ble_cmd_cb_t callback);
ble_err_t bk_ble_set_extended_scan_params(
                uint8_t    own_address_type,
                ...
                ble_cmd_cb_t callback);
ble_err_t bk_ble_set_extended_scan_enable(
                uint8_t   enable,
