...
extern void lcd_8080_rgb565_scale_down_test(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
extern void lcd_rgb_scale_down_init(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
extern void lcd_rgb_scale_down_test(char *pcWriteBuffer, int xWriteBufferLen, int argc, char **argv);
...
static const struct cli_command s_lcd_commands[] = {
	...
	{"lcd_8080_scale_down", "lcd_close", lcd_8080_rgb565_scale_down_test},
	{"lcd_rgb_scale_init", "lcd_rgb_init", lcd_rgb_scale_down_init},
	{"lcd_rgb_scale_test", "lcd_rgb_scale_down_test", lcd_rgb_scale_down_test},

	//{"psram_memcpy", "lcd_close", lcd_psram_memcpy_test},
};
