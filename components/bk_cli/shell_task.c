...
static const u16     shell_fault_str_len = sizeof(shell_fault_str);
#else
...
void shell_task( void *para )
{
	...
	strcpy((char *)&cmd_line_buf.cmd_buff[0], "\r\n#");
	echo_out(&cmd_line_buf.cmd_buff[0], strlen((char *)&cmd_line_buf.cmd_buff[0]));
	...
	while(bTRUE)
	{
		...
		{
			strcpy((char *)&cmd_line_buf.cmd_buff[0], "Unsolicited\r\n#");
			echo_out(&cmd_line_buf.cmd_buff[0], strlen((char *)&cmd_line_buf.cmd_buff[0]));
