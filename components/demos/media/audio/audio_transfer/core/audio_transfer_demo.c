...
audio_tras_demo_info_t aud_tras_info;
...
bk_err_t audio_tras_demo_init(audio_tras_demo_setup_t demo_setup)
{
	...
	aud_tras_drv_setup.samp_rate = demo_setup.samp_rate;
	aud_tras_drv_setup.aec_enable = demo_setup.aec_enable;
	/* audio config */
	...
	aud_tras_drv_setup.aud_cb.audio_send_mic_data = demo_setup.audio_send_mic_data;
