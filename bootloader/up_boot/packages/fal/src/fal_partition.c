...
void fal_show_part_table(void)
{
    ...
    extern const uint32_t *flash_current_config;

    bk_printf("\033[36;22m"); 
    bk_printf("[I/OTA] bootloader build @ %s %s FLASH ID: %06X(%s)\r\n", __DATE__, __TIME__, flash_id, (*flash_current_config == 0)?"unkown":"OK");
    bk_printf("\033[0m");
}
