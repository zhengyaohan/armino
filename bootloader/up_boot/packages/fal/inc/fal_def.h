...
#undef  log_d
#endif
#define log_d(...)                     bk_printf("[D/FAL] (%s:%d) ", __FUNCTION__, __LINE__);           bk_printf(__VA_ARGS__);bk_printf("\n")
...
#undef  log_e
#endif
#define log_e(...)                     bk_printf("\033[31;22m[E/FAL] (%s:%d) ", __FUNCTION__, __LINE__);bk_printf(__VA_ARGS__);bk_printf("\033[0m\n")

/* info level log */
#ifdef  log_i
#undef  log_i
#endif
#define log_i(...)                     bk_printf("\033[32;22m[I/FAL] ");                                bk_printf(__VA_ARGS__);bk_printf("\033[0m\n")
