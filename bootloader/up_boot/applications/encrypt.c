...
extern u32    coef0 ;//= (u32)0x510fb093 ;//0x12345678;
extern u32    coef1 ;//= (u32)0xa3cbeadc ;//0x2faa55aa;
extern u32    coef2 ;//= (u32)0x5993a17e ;//0x3aee63dd;
extern u32    coef3 ;//= (u32)0xc7adeb03 ;//0x4feeaa00;

typedef  struct __attribute__((packed)) encrypt_packet 
{
    uint8_t data[CRC_PAKEIT];
...
void encrypt(u32 *rx, uint8_t *tx, u32 num,u32  addr0)
{
    uint8_t *tmp_rx;
    u32 rx_value, ret;
    u32 i, j, addr, addr1;
