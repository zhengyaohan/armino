...
#else
#define REG_GPIO_32_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x30 * 4)
#define REG_GPIO_33_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x31 * 4)
#define REG_GPIO_34_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x32 * 4)
#define REG_GPIO_35_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x33 * 4)
#define REG_GPIO_36_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x34 * 4)
#define REG_GPIO_37_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x35 * 4)
#define REG_GPIO_38_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x36 * 4)
#define REG_GPIO_39_CONFIG_ADDR             (REG_GPIO_BASE_ADDR + 0x37 * 4)
#endif
...
#define REG_GPIO_FUNTION_MODE_ADDR2          (REG_GPIO_BASE_ADDR + 0x2e * 4)
#define REG_GPIO_FUNTION_MODE_MASK2          0xFFFFFFFFUL
#define REG_GPIO_FUNTION_MODE2               (*((volatile unsigned long *) REG_GPIO_FUNTION_MODE_ADDR2))

#define REG_GPIO_FUNTION_MODE_ADDR3          (REG_GPIO_BASE_ADDR + 0x2f * 4)
#define REG_GPIO_FUNTION_MODE_MASK3          0xFFFFFFFFUL
#define REG_GPIO_FUNTION_MODE3               (*((volatile unsigned long *) REG_GPIO_FUNTION_MODE_ADDR3))
...
#if (SOC_BK7271 == CFG_SOC_NAME)
#define GPIO_UART0_RX_CONFIG                REG_GPIO_0_CONFIG
#define GPIO_UART0_TX_CONFIG                REG_GPIO_1_CONFIG
#else
...
#if (SOC_BK7271 == CFG_SOC_NAME)
#define GPIO_UART1_TX_PIN                   6
#define GPIO_UART1_RX_PIN                   7
#else
#define GPIO_UART1_TX_PIN                   0
#define GPIO_UART1_RX_PIN                   1
#endif
#if (SOC_BK7271 == CFG_SOC_NAME)
#define GPIO_UART1_TX_CONFIG                REG_GPIO_7_CONFIG
#define GPIO_UART1_RX_CONFIG                REG_GPIO_6_CONFIG
#else
...
#define GPIO_SD0_CLK_PIN                     14
#define GPIO_SD0_CMD_PIN                     15
#define GPIO_SD0_DATA0_PIN                   16
#define GPIO_SD0_DATA1_PIN                   17
#define GPIO_SD0_DATA2_PIN                   18
#define GPIO_SD0_DATA3_PIN                   19
#define GPIO_SD0_CLK_CONFIG                  REG_GPIO_14_CONFIG
#define GPIO_SD0_CMD_CONFIG                  REG_GPIO_16_CONFIG
#define GPIO_SD0_DATA0_CONFIG                REG_GPIO_17_CONFIG
#define GPIO_SD0_DATA1_CONFIG                REG_GPIO_19_CONFIG
#define GPIO_SD0_DATA2_CONFIG                REG_GPIO_18_CONFIG
#define GPIO_SD0_DATA3_CONFIG                REG_GPIO_15_CONFIG

#define GPIO_SD1_CLK_PIN                     34
#define GPIO_SD1_CMD_PIN                     35
#define GPIO_SD1_DATA0_PIN                   36
#define GPIO_SD1_DATA1_PIN                   37
#define GPIO_SD1_DATA2_PIN                   38
#define GPIO_SD1_DATA3_PIN                   39
#define GPIO_SD1_CLK_CONFIG                  REG_GPIO_34_CONFIG
#define GPIO_SD1_CMD_CONFIG                  REG_GPIO_35_CONFIG
#define GPIO_SD1_DATA0_CONFIG                REG_GPIO_36_CONFIG
#define GPIO_SD1_DATA1_CONFIG                REG_GPIO_37_CONFIG
#define GPIO_SD1_DATA2_CONFIG                REG_GPIO_38_CONFIG
#define GPIO_SD1_DATA3_CONFIG                REG_GPIO_39_CONFIG
...
#define ICU_GPIO_MULTICOMPLEXING_UART2_MASK          (1)
#define ICU_GPIO_MULTICOMPLEXING_UART2_GPIO6_GPIO7   (0)
#define ICU_GPIO_MULTICOMPLEXING_UART2_GPIO16_GPIO17 (1)
...
#define REG_GPIO_FUNTION_MODE_3             (*((volatile unsigned long *) REG_GPIO_FUNC_CFG_3))
    ...
    extern void GPIO_SD_fuction_enable(unsigned char ucChannel);
#ifdef __cplusplus
}
#endif  /* __cplusplus */
