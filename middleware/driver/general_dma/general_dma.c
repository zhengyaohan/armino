...
static const DD_OPERATIONS gdma_op = {
	NULL,
	NULL,
	NULL,
	NULL,
...
void gdma_init(void)
{
	...
	bk_int_isr_register(INT_SRC_GDMA, gdma_isr, NULL);
	sddev_register_dev(DD_DEV_TYPE_GDMA, (DD_OPERATIONS *)&gdma_op);
...
void gdma_exit(void)
{
	...
	sddev_unregister_dev(DD_DEV_TYPE_GDMA);
}
