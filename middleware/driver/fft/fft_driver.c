...
bk_err_t bk_fft_driver_init(void)
{
	if (s_fft_driver_is_init)
		return BK_OK;
	//power on
	pm_module_vote_power_ctrl(PM_POWER_SUB_MODULE_NAME_AUDP_FFT, PM_POWER_MODULE_STATE_ON);
...
{
	//power down
	pm_module_vote_power_ctrl(PM_POWER_SUB_MODULE_NAME_AUDP_FFT, PM_POWER_MODULE_STATE_OFF);
