...
/*****************************************************************************
* Copyright (c) 2008-2017 INSIDE Secure B.V. All Rights Reserved.
*
...
#define LOG_SEVERITY_CRIT       0
#define LOG_SEVERITY_CRITICAL   0
#define LOG_SEVERITY_WARN       0
#define LOG_SEVERITY_WARNING    0
