        ...
        const uint32_t TxtLen)
{
    ...
    case VAL_SYM_ALGO_CIPHER_ARIA:
        ...
        case TESTVECTORS_MODE_ICM:
            ...
            KeyAssetPolicy = VAL_POLICY_MODE5;
            IvSize = VAL_SYM_ALGO_AES_IV_SIZE;
            TestCntxt_p->fPadding = true;
            TestCntxt_p->PaddingByte = 0xDC;
            break;
        ...
        case TESTVECTORS_MODE_F8:
            ...
            KeyAssetPolicy = VAL_POLICY_MODE8;
            IvSize = VAL_SYM_ALGO_AES_IV_SIZE;
            TestCntxt_p->fPadding = true;
            TestCntxt_p->PaddingByte = 0xDC;
            break;
        ...
        case TESTVECTORS_MODE_XTS:
            ...
            KeyAssetPolicy = VAL_POLICY_MODE9;
            IvSize = VAL_SYM_ALGO_AES_IV_SIZE;
            TestCntxt_p->fPadding = true;
        ...
        {
            KeyAssetPolicy |= VAL_POLICY_ALGO_CIPHER_AES;
            TestCntxt_p->BlockSize = VAL_SYM_ALGO_AES_BLOCK_SIZE;
        }
        else
        {
            KeyAssetPolicy |= VAL_POLICY_ALGO_CIPHER_ARIA;
    ...
    case VAL_SYM_ALGO_CIPHER_TRIPLE_DES:
        ...
        case TESTVECTORS_MODE_ECB:
            Mode = VAL_SYM_MODE_CIPHER_ECB;
            KeyAssetPolicy = VAL_POLICY_ALGO_CIPHER_TRIPLE_DES|VAL_POLICY_MODE1;
            break;
        case TESTVECTORS_MODE_CBC:
            Mode = VAL_SYM_MODE_CIPHER_CBC;
            KeyAssetPolicy = VAL_POLICY_ALGO_CIPHER_TRIPLE_DES|VAL_POLICY_MODE2;
            IvSize = VAL_SYM_ALGO_DES_IV_SIZE;
            break;
        default:
            break;
    ...
    case VAL_SYM_ALGO_CIPHER_SM4:
        ...
        case TESTVECTORS_MODE_ECB:
            Mode = VAL_SYM_MODE_CIPHER_ECB;
            KeyAssetPolicy = VAL_POLICY_ALGO_CIPHER_SM4|VAL_POLICY_MODE1;
            break;
        case TESTVECTORS_MODE_CBC:
            Mode = VAL_SYM_MODE_CIPHER_CBC;
            KeyAssetPolicy = VAL_POLICY_ALGO_CIPHER_SM4|VAL_POLICY_MODE2;
            IvSize = VAL_SYM_ALGO_AES_IV_SIZE;
            break;
        case TESTVECTORS_MODE_CTR:
            Mode = VAL_SYM_MODE_CIPHER_CTR;
            KeyAssetPolicy = VAL_POLICY_ALGO_CIPHER_SM4|VAL_POLICY_MODE4;
    ...
    {
        KeyAssetPolicy |= VAL_POLICY_ENCRYPT|VAL_POLICY_DECRYPT;
...
valtest_IsChaCha20Supported(void)
{
    ...
    tv_p = test_vectors_chacha20_get(0);
    if (tv_p == NULL)
    {
...
valtest_IsSM4Supported(void)
{
    ...
    tv_p = test_vectors_sm4_basic_get(0);
    if (tv_p == NULL)
    {
...
valtest_IsARIASupported(void)
{
    ...
    tv_p = test_vectors_aria_basic_get(0);
    if (tv_p == NULL)
    {
...
START_TEST(test_sym_crypto_invalid_algorithm)
{
    ...
    Status = val_SymCipherUpdate(SymContext_p,
                                 ...
                                 outData,
                                 &outDataSize);
    fail_if(Status != VAL_INVALID_ALGORITHM, "val_SymCipherUpdate()=", Status);
...
START_TEST(test_sym_crypto_buffer_too_small)
{
    ...
    Status = val_SymCipherUpdate(SymContext_p,
                                 ...
                                 outData,
                                 &outDataSize);
    fail_if(Status != VAL_BUFFER_TOO_SMALL, "val_SymCipherUpdate()=", Status);
