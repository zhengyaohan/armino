...
int test_vectors_aria_gcm_num(void);
...
*/
TestVector_ARIA_GCM_t test_vectors_aria_gcm_get(int Index);

/* Release a vector.
   It is mandatory to release a vector once user of test vector is finished
   with the vector. */
void test_vectors_aria_gcm_release(TestVector_ARIA_GCM_t Vector_p);
