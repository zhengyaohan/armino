...
VAL API use in combination with the EIP-13x driver. It shows the usage of
the VAL API. It is built both for kernel deployment (the demo application
...
interface for the EIP-13x tokens and the DMA interface for reading and writing
data from EIP-13x point of view.
