...
#ifndef INCLUDE_GUARD_CS_HWPAL_BK_H
#define INCLUDE_GUARD_CS_HWPAL_BK_H

/**----------------------------------------------------------------------------
 * This module uses (requires) the following interface(s):
 */

#include "cs_hwpal_umdevxs.h"		////WHY  ????
...
#endif // INCLUDE_GUARD_CS_HWPAL_BK_H


/* end of file cs_hwpal_bk.h */
