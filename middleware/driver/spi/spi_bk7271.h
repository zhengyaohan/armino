...
#define SPI_STAT_RXFIFO_RD_POSI				2
#define SPI_STAT_TXFIFO_WR_POSI				1
...
#define DD_DEV_TYPE_SPI_SLECT     DD_DEV_TYPE_SPI3
#if (DD_DEV_TYPE_SPI_SLECT == DD_DEV_TYPE_SPI3)
#define SPI3_MODULE_SLECT         GFUNC_MODE_SPI3_2	//GFUNC_MODE_SPI3_1
#else
#define SPI3_MODULE_SLECT
#endif
