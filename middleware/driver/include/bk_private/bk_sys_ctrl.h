...
enum
{
	...
	#if (!CONFIG_SOC_BK7231) && (!CONFIG_SOC_BK7231N) && (!CONFIG_SOC_BK7236A) && (!CONFIG_SOC_BK7256XX) && (!CONFIG_SOC_BK7256_CP1)
...
#define BLK_BIT_USB                              (1 << 14)
#elif (CONFIG_SOC_BK7231N) || (CONFIG_SOC_BK7236A) || (CONFIG_SOC_BK7256XX) || (CONFIG_SOC_BK7256_CP1)
#define BLK_BIT_AUDIO_RANDOM_GENERATOR           (1 << 15)
