...
enum
{
	...
	#if (CONFIG_SOC_BK7231N) || (CONFIG_SOC_BK7236) || (CONFIG_SOC_BK7256) || (CONFIG_SOC_BK7256_CP1)
	CMD_BLE_RF_PTA_EN,
	CMD_BLE_RF_PTA_DIS,
	#endif
	...
	#if (!CONFIG_SOC_BK7231) && (!CONFIG_SOC_BK7231N) && (!CONFIG_SOC_BK7236) && (!CONFIG_SOC_BK7256) && (!CONFIG_SOC_BK7256_CP1)
...
#if (CONFIG_SOC_BK7231N) || (CONFIG_SOC_BK7256) || (CONFIG_SOC_BK7256_CP1)
...
#define BLK_BIT_USB                              (1 << 14)
#elif (CONFIG_SOC_BK7231N) || (CONFIG_SOC_BK7236) || (CONFIG_SOC_BK7256) || (CONFIG_SOC_BK7256_CP1)
#define BLK_BIT_AUDIO_RANDOM_GENERATOR           (1 << 15)
