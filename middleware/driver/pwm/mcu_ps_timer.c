...
{
	return ((icu_get_irq_int_status()) & (BIT(IRQ_PWM))) && (REG_READ(PWM_INTERRUPT_STATUS) & 0x1);
}
...
#if (CONFIG_SOC_BK7231U) || (CONFIG_SOC_BK7231N) || (CONFIG_SOC_BK7236) || (CONFIG_SOC_BK7256XX)
