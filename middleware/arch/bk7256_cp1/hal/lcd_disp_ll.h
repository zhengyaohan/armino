...
#define LCD_LL_REG_BASE(_lcd_disp_unit_id)    (SOC_LCD_DISP_REG_BASE)
...
{
	return hw->display_int.v & 0xffff;
}
...
static inline void lcd_display_ll_rgb_disconti_mode (lcd_disp_hw_t *hw, bool en)
{
