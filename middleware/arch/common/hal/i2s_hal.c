...
bk_err_t i2s_hal_int_set(i2s_int_en_config_t *int_config)
{
	switch(int_config->channel_id)
	{
		case I2S_CHANNEL_1:
			i2s_ll_set_reg0x1_txudf_en(int_config->tx_udf_en);
			i2s_ll_set_reg0x1_rxovf_en(int_config->rx_ovf_en);
			i2s_ll_set_reg0x1_txint_en(int_config->tx_int_en);
			i2s_ll_set_reg0x1_rxint_en(int_config->rx_int_en);
			break;
		case I2S_CHANNEL_2:
			i2s_ll_set_reg0x4_tx2udf_en(int_config->tx_udf_en);
			i2s_ll_set_reg0x4_rx2ovf_en(int_config->rx_ovf_en);
			i2s_ll_set_reg0x4_tx2int_en(int_config->tx_int_en);
			i2s_ll_set_reg0x4_rx2int_en(int_config->rx_int_en);
			break;
		case I2S_CHANNEL_3:
			i2s_ll_set_reg0x4_tx3udf_en(int_config->tx_udf_en);
			i2s_ll_set_reg0x4_rx3ovf_en(int_config->rx_ovf_en);
			i2s_ll_set_reg0x4_tx3int_en(int_config->tx_int_en);
			i2s_ll_set_reg0x4_rx3int_en(int_config->rx_int_en);
			break;
		case I2S_CHANNEL_4:
			i2s_ll_set_reg0x4_tx4udf_en(int_config->tx_udf_en);
			i2s_ll_set_reg0x4_rx4ovf_en(int_config->rx_ovf_en);
			i2s_ll_set_reg0x4_tx4int_en(int_config->tx_int_en);
			i2s_ll_set_reg0x4_rx4int_en(int_config->rx_int_en);
			break;
		default:
			break;
	}
