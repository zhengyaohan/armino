...
macro(project project_name)
    ...
    add_custom_target(size-statistic
        DEPENDS ${project_elf}
        COMMAND ${armino_size_statistic} --soc "${BDK_SOC}" --dirs "${armino_path}/components/bk_libs" --outfile "${armino_path}/build/size_map.txt"
    )
    add_custom_target(temp ALL DEPENDS size-statistic)
    unset(armino_size)
    unset(armino_size_statistic)
