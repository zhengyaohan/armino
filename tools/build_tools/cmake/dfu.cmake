...
function(__add_dfu_targets)
    ...
    if("${target}" STREQUAL "bk7231n")
        return()
    elseif("${target}" STREQUAL "bk7251")
        return()
    elseif("${target}" STREQUAL "bk7271")
        return()
    elseif("${target}" STREQUAL "bk7231u")
        return()
    elseif("${target}" STREQUAL "bk7236")
        return()
    elseif("${target}" STREQUAL "bk7256")
        return()
    elseif("${target}" STREQUAL "bk7256_cp1")
        return()
    else()
